    ...
    <div class="admin-card">
        <div class="grid gap-5 sm:grid-cols-2">
            <div class="sm:col-span-2">
                ...
                <input class="form-input" type="text" id="title" name="title" value="{{ old('title', $article->title) }}" required>
            </div>
            <div>
                <label class="form-label" for="slug">Slug (URL)</label>
                <input class="form-input" type="text" id="slug" name="slug" value="{{ old('slug', $article->slug) }}" placeholder="otomatis dari judul">
            </div>
            <div>
